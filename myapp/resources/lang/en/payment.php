<?php
    return[
        ...
        'thank-you-for-choosing' => 'Thank you for choosing Eva\'a Event & Com. You should receive an email confirming your order shortly.',
        'keep-your-confirmation' => 'Please keep your confirmation number for your records',
        'order-history' => 'Go to "Order History" in your account to see the details.',
        'order-is-pending' => 'Your order is pending. it will be processed upon receipt of payment and purchase order. Please follow these steps to complete the order process:',
        // OFFRE
        ...
        'enter-payment-details' => 'Once you\'ve sent your payement, return to our website and log in to your account. Go to "Order History", then click on "Enter payement details" button to fill in the information needed to confirm your order',
    ];
?>
