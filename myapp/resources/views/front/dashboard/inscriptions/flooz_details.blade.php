                                    ...
                                    <div class="card-body px-lg-5 pt-0">
                                        ...
                                        <form class="register-form" action="{{ route('inscription.confirm', $inscription->id) }}" method="POST" autocomplete="off">
                                            ...
                                            <div class="text-left mt-3">
                                                ...
                                                <input id="paymentOption" value="{{$inscription->paymentOption}}" name="paymentOption" disabled  type="text" placeholder="" class="form-control height-45" required autocomplete="off">
                                            </div>
