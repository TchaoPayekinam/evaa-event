...
<section class="section-space-default bg-light">
    <div class="container zoom-gallery menu-list-wrapper">
        ...
        <div class="schedule-layout2">
            <ul class="schedule-nav nav nav-tabs d-flex w-100">
                <li class="nav-item flex-fill">
                    <a href="#one" data-toggle="tab" aria-expanded="false" class="nav-link active text-center">
                        <div class="day-number">{{ trans('dashboard.registration') }}</div>
                    </a>
                </li>
                <li class="nav-item flex-fill">
                    <a href="#two" data-toggle="tab" aria-expanded="false" class="nav-link text-center">
                                ...
                                <tbody>
                                    @foreach ($inscriptions as $inscription)
                                        <tr>
                                            ...
                                            <td>{{ $inscription->is_validate == 0 ? trans('dashboard.false') : trans('dashboard.true') }}</td>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ trans('dashboard.status_' . $payment->status) }}</td>
                                        <td>{{ $payment->is_validate == 0 ? trans('dashboard.false') : trans('dashboard.true') }}</td>
