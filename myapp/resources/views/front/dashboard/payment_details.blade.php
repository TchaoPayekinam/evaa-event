            ...
            <div class="row evaa-container">
                <div class="col-lg-12 col-md-12 margin-b-30rem">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>
                                Veillez confirmer votre inscription à la formation {{ $payment->event->name}}
                            </p>
                            <p>
                                Vous avez choisi {{$payment->paymentOption}} comme option de payement préferé
                            </p>
                            <p>
                                Voici votre code de confirmation {{$payment->confirmationCode}}
                            </p>
                            <p class="font-italic">
                            ...
                            <div class="ml-md-2">
                                <ol class="my-3">
                                    <li>
                                        <span class="font-weight-bold">Envoyer le paiement par {{$payment->paymentOption}}
                                            </span>
                                        <p>Le paiement par {{$payment->paymentOption}} est possible si vous résidez au Togo et dans les pays suivantes : Bénin, Burkina Faso, Côte d’Ivoire, Guinée-Bissau, Mali et Niger.</p>
                                        <p>{{ trans('payment.flooz-point-of-sale') }}</p>
                                        <ul class="list-unstyled pl-4">
                                            <li>Flooz number : <strong><em>+228 96028282</em></strong></li>
                                            <li>Payement amount : <em>{{$payment->paymentAmount}} FCFA</em></li>
                                    ...
                                    <div class="card-body px-lg-5 pt-0">
                                        ...
                                        <form class="register-form" action="{{ route('payment.confirm', $payment->id) }}" method="POST" autocomplete="off">
                                            ...
                                            <div class="text-left mt-3">
                                                ...
                                                <span class="small">Voici un exemple de reference {{ $payment->paymentOption == 'Flooz' ? 'Txn ID: 2240202149567' : ($payment->paymentOption == 'T-Money' ? 'Ref: 3422489595' : '') }}</span>
                                            ...
                                            <div class="text-left mt-3">
                                                ...
                                                <input id="optionAmount" name="optionAmount" disabled value="{{$payment->paymentOption}}" type="text" placeholder="" class="form-control height-45" required autocomplete="off">
