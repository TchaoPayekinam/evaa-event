        ...
        <div class="container">
            <div class="row evaa-container">
                <div class="col-lg-12 col-md-12 margin-b-30rem">
                    <div class="card">
                        <h2 class="card-header text-center py-4 mt-0 poti-light-bg">{{ trans('payment.register-fees-payment') }} {{ trans('payment.payment-by-tmoney') }} - {{ trans('payment.step-one') }}</h2>
                        <div class="card-body">
                            <p>
