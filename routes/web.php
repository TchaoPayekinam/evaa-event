...
Route::get('/administration/connexion', [App\Http\Controllers\Admin\AdminController::class, 'adminLoginForm'])->name('admin.login');
Route::post('/administration/login', [\App\Http\Controllers\Admin\AdminController::class, 'doLogin'])->name('admin.doLogin');
