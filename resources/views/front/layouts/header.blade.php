<header>
    ...
    <div class="header-toolbar-area">
        ...
        <ul class="nav lang">            
            <li class="nav-item">
                <a class="nav-link" title="Lisez cette page en français" lang="fr" href="/fr/" hreflang="fr">Français</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" title="Read this page in English" lang="en" href="/" hreflang="en">English</a>
            </li>
        </ul>
    </div>
                            ...
                            <nav class="d-none d-lg-block">
                                <ul>
                                    <li class="{{ Request::is('/*') ? 'current' : ''}}">
                                        ...
                                        <!-- <ul class="rt-dropdown-menu third-level">
                                            <li>
                                                <ul>
                                                    <li class="current">
                                    ...
                                    <li class="menu-justify {{ Request::is('about*') ? 'current' : ''}}">
                                        <a href="{{ route('home.about') }}">A Propos</a>
