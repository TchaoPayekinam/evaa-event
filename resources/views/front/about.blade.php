            ...
            <div class="row full-width row-1">
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="speaker-layout2">
                        <img src="{{ asset('event/assets/img/speaker1.jpg') }}" alt="speaker" class="img-fluid">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-12">
                        <div class="sponsonrs-box">
                            <a href="#">
                                <img src="{{ asset('event/assets/img/OtnielGalerie-logo.png') }}" alt="brand" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6 col-12">
