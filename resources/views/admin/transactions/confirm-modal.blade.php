        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <p class="mt-3">Voulez-vous annuler la reception de cette transaction?</p>
                </div>
                <form class="pl-3 pr-3" action="{{ route('payment.confirm_transaction_reset', $transaction->id) }}" method="POST">
                    {!! csrf_field() !!}
