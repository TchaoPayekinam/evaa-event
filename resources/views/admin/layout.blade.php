...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        <button class="nav-link btn-fill size-xs color-yellow border-radius-5 mr-2">{{ trans('menu.deconnexion') }}</button>
      </ul>
  ...
  <script src="{{ asset('assets/js/dynamc_fields.js') }}"></script> 
